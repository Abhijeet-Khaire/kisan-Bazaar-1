...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors group-[.destructive]-muted/40 hover-secondary group-[.destructive]-destructive/30 group-[.destructive]-destructive group-[.destructive]-destructive-foreground focus-none focus-2 focus-ring focus-offset-2 group-[.destructive]-destructive disabled-events-none disabled-50",
      className,
    )}
    {...props}
  />
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity group-hover-100 group-[.destructive]-red-300 hover-foreground group-[.destructive]-red-50 focus-100 focus-none focus-2 group-[.destructive]-red-400 group-[.destructive]-offset-red-600",
      className,
    )}
    toast-close=""
    {...props}
