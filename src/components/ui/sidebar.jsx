  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]-h-[calc(100svh-theme(spacing.4))] md-data-[variant=inset]:m-2 md-data-[state=collapsed]-data-[variant=inset]-2 md-data-[variant=inset]-0 md-data-[variant=inset]-xl md-data-[variant=inset]",
        className,
      )}
      {...props}
    />
